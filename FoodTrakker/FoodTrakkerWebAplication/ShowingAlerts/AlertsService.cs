namespace FoodTrakkerWebAplication.ShowingAlerts
{
    public class AlertsService
    {
        public static string ShowAlert(Alerts obj, string message)
        {
            ...
            {
                case Alerts.Success:
                    alertDiv = "<div class='alert alert-success alert-dismissable' id='alert'><button type='button' class='close' data-dismiss='alert'>×</button><strong></ strong > " + message + "</a></div>";
                    break;
                case Alerts.Danger:
